...
def test_rule_count_matches_seed() -> None:
    ...
    # overlay_text) plus four video spoken-claim rules (M3:
...
def test_spoken_rules_mirror_their_copy_counterparts() -> None:
    # M3: the video voiceover-claim rules must detect the SAME claims as their
    # copy counterparts (a claim is the same violation whether spoken or
