...
/**
 * Canonical shadcn/ui `<Checkbox />`, built on `@radix-ui/react-checkbox`.
 * Supports the `indeterminate` state (Radix `checked="indeterminate"`) for
 * DataTable "select all on page" header checkboxes - rendered as a dash.
 */
